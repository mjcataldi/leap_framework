# LEAP Phase 0 — Standard Operational Prompt — v1.6
...
C5: Coding-Prompt Ready — only after Recon, source truth, repo reality, scope, tests, and stop conditions are clear
```
